...
This term the topic of Visual Analytics Project will be based on either [VAST Challenge 2026](https://vast-challenge.github.io/2026/index.html). There are two Mini Challenges (MC). Teams are required to choose **one** of the MC and build a Shiny Application to answer the questions of the challenge.
...
- Editing and publishing project proposal on Vercel latest by the end of **10th June 2026 at 11:59pm (mid-night)**.
- Uploading project poster on eLearn by **1st July 2026 (Wednesday) at 11:59pm (mid-night)**.
- Poster presentation: **4th July 2026 (Saturday), 1:00pm-2:30pm**
- Submission of Shiny application repository, project website repository, project poster, Minutes of Meeting and Peer Evaluation: **5th July 2026 (Sunday) by 11:59pm (mid-night)**

## Project Deliverable

### Project Website

At the beginning of the project, project teams are required to create a project website by using [**Quarto**](https://quarto.org/docs/websites/). The project website should include, beside others, project overview, prototypes, storyboards, analysis and results, poster and user guide. The project website repository must be uploaded on github and publish on **Vercel**. **Git** must be used to maintain a complete project version control including the application and project documents. By the end of the project, the project team must pack the final version of the **Github** repository and upload onto eLearn for final submission. The Github link also must be provided on eLearn.
